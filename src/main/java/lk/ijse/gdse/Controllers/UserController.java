...
public class UserController {
    ...
    public boolean isValied() {
        ...
        if (!Regex.setTextColor(lk.ijse.gdse.util.Regex.TextField.CONTACT, txtPhone)) return false;
    ...
    void Phone(KeyEvent event) {
        Regex.setTextColor(lk.ijse.gdse.util.Regex.TextField.CONTACT, txtPhone);
    }
}
