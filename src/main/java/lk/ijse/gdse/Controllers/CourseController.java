...
import lk.ijse.gdse.BO.CourseBO;
...
public class CourseController {
    ...
    public boolean isValied(){
        if (!Regex.setTextColor(lk.ijse.gdse.util.Regex.TextField.NAME,txtProgramName)) return false;
        return true;
    }
    ...
    void Programme_Name(KeyEvent event) {
        ...
        Regex.setTextColor(lk.ijse.gdse.util.Regex.TextField.NAME,txtProgramName);
    }
